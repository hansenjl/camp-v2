    ...
    def create
      ...
      new_data = CSV.generate do |csv|
        ...
        ### make the line below more dynamic and/or move the array part to the Camper class
          csv << [c.session, c.name_used, "", c.age, c.grade, c.prev_grade, c.first, c.last, c.city.name, c.school, c.birthdate, c.tribe, c.sibling_tribe, c.years_at_ozark, c.group_id, c.group_id2, c.rid2, c.prev_cab, c.past_camper_rating, c.balance, c.discount, c.campmom_med_discount, c.parent_notes, c.admin_notes, "", "", c.request_1, "", "", c.request_2, "", "", c.ofa_group, c.sibs]
        end
      end
      new_data
    end
